...
public class ReplicatorBlockItem extends MachineBlockItem {
    public ReplicatorBlockItem(Block block, Properties props, MachineType type, ITier tier) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        if (Screen.hasAltDown()) {
            tooltip.add(Component.literal(I18n.get("youmatter.tooltip.replicator")));
        }
    }
}
