...
public class YMConfig {
    ...
    YMConfig(ModConfigSpec.Builder builder) {
        ...
        overrides = builder
                ...
                .defineListAllowEmpty("overrides", Lists.newArrayList("minecraft:diamond=2500", "minecraft:nether_star=5000"), e -> e instanceof String && ((String) e).contains(":") && ((String) e).contains("="));
