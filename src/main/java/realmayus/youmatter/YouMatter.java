...
import realmayus.youmatter.network.*;
...
public class YouMatter {
    ...
    public void registerPayloads(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToServer(
                PacketChangeSettingsCreatorServer.TYPE,
                PacketChangeSettingsCreatorServer.STREAM_CODEC,
                PacketHandler.CreatorSettings::handle
        );
        registrar.playToServer(
                PacketShowNext.TYPE,
